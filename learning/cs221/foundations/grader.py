...
grader.addManualPart('1e', maxPoints=4, description='take gradient')
...
grader.addManualPart('2d', maxPoints=4, description='preprocessing with matrices')
...
grader.addHiddenPart('3c-1-hidden', test, maxPoints=2, description='random trials')
...
def test():
    ...
    for _ in range(10):
        ...
        ans2 = submission.mutateSentences(sentence)
grader.addHiddenPart('3c-2-hidden', test, maxPoints=3, description='random trials (bigger)')
...
grader.addHiddenPart('3d-1-hidden', test, maxPoints=3, description='random trials')
...
def test():
    ...
    for _ in range(10):
        ...
        for key in list(v1b):
          if v1b[key] == 0:
            del v1b[key]
grader.addHiddenPart('3e-1-hidden', test, maxPoints=3, description='random trials')
...
grader.addHiddenPart('3f-2-hidden', lambda : test3f(10000, 100), maxPoints=2, description='random trials (bigger)')
...
def test3g():
    ...
    grader.requireIsEqual(3, submission.computeLongestPalindromeLength("aaa"))
...
grader.addHiddenPart('3g-5-hidden', lambda : test3g(5, 400), maxPoints=1, maxSeconds=2, description='random trials (longer)')
"""

############################################################
# Problem 4: societal impact

grader.addManualPart('4a', maxPoints=1, description='positive impacts')
grader.addManualPart('4b', maxPoints=1, description='negative impacts')

############################################################
# Problem 5: background

grader.addManualPart('5a', maxPoints=1, description='background courses')
grader.addManualPart('5b', maxPoints=1, description='background concepts')
